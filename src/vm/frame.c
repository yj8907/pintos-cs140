...
falloc_get_frame(void* vm_pg, void *eip, enum palloc_flags flags)
{
    ...
    if (page == NULL) {
        ...
        if (new_frame == 0x0030d000) printf("test0");
        evict_frame(new_frame, 1);
        page = palloc_get_page(flags);
        
    }
    if (new_frame == 0x0030d000) printf("test1");
    ...
    if (new_frame == 0x0030d000) printf("test2");
