...
void *vm_alloc_page(struct vm_mm_struct* vm_mm, size_t page_cnt, enum palloc_flags, enum page_data_type);

void *vm_mm_init(void);
void vm_update_page(thread* t, void* pg, enum page_state, uint32_t);
